...
NAME=$1
OUTDIR="/mnt/disks/barcode-tender-manuscript/ADT_count_benchmarking/kite_threads/${NAME}"
...
BARCODES="/mnt/disks/barcode-tender-manuscript/ADT_count_benchmarking/kite_threads/${NAME}_barcodes.tsv"
...
COMMAND="/shared/apps/kallisto/kallisto bus -i $INDEX -o $OUTDIR -x 10xv3 -t 8 "${READ_PAIRS[*]}""
$( $COMMAND )
...
$( /shared/apps/bustools/bustools sort -t 8 -o "${OUTDIR}/output_sorted.bus" "${OUTDIR}/output_corrected.bus" )
